...
export class KontaktComponent {
  ...
  sendMail() {
    ...
    let phoneField = this.phoneField.nativeElement;
    this.mailSendToServer(nameField, emailField, messageField, phoneField);
    this.BtnDisable();
  }

  async mailSendToServer(
  ...
  BtnDisable() {
    ...
    this.phoneField.nativeElement.disabled = true;
  ...
  inputValueNull() {
    ...
    this.phoneField.nativeElement.value = '';
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          this.phoneField.nativeElement.disabled = false;
        }, 5000);
      }, 5000);
    }, 3000);
  }
